...
class STracker(object):
    def __init__(self, cfg, args, slam):
        ...
        # self.shared_decoder = slam.shared_decoders
    ...
    def optimize_cam_in_batch(self, camera_tensor, gt_depth, gt_color, batch_size, optimizer):
        ...
        depth, color, acc = ret
        # ret = self.render.render_batch_ray(
        #     self.c, self.shared_decoder, batch_rays_d, batch_rays_o, self.device, stage='color', gt_depth=batch_gt_depth)
        # depth, acc, color = ret
